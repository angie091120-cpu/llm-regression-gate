...
# 46 until 2026-09-19, when the blind re-labelling import added 62: the two new
...
# (14), every branch of the gold v2 decision rule on synthetic sheets (17), the
# gold v2 re-grading, family labelling and difference listing (11), the dataset
# write-out including the labeled_at rule (7), and E4's three-rater panel rows
# (6). C3 asserts the count as well as the result, so a test file that stops
# being collected fails here instead of passing quietly.
EXPECTED_TESTS="${EXPECTED_TESTS:-108}"
